# Extract 5-tuple events from sentences
...
# SETUP NOTICE: please unzip the stanford files before continuing
verbnet = nltk.corpus.VerbnetCorpusReader('./tools/v3.3',
                                          ['absorb-39.8.xml', 'accept-77.1.xml', 'accompany-51.7.xml',
                                           'acquiesce-95.1.xml', 'act-114.xml', 'addict-96.xml', 'adjust-26.9.xml',
                                           'admire-31.2.xml', 'admit-64.3.xml', 'adopt-93.xml', 'advise-37.9.xml',
                                           'allow-64.1.xml', 'amalgamate-22.2.xml', 'amuse-31.1.xml',
                                           'animal_sounds-38.xml', 'appeal-31.4.xml', 'appear-48.1.1.xml',
                                           'appoint-29.1.xml', 'assessment-34.1.xml', 'assuming_position-50.xml',
                                           'attend-107.4.xml', 'avoid-52.xml', 'banish-10.2.xml', 'base-97.1.xml',
                                           'battle-36.4.xml', 'become-109.1.xml', 'beg-58.2.xml', 'begin-55.1.xml',
                                           'being_dressed-41.3.3.xml', 'bend-45.2.xml', 'benefit-72.2.xml',
                                           'berry-13.7.xml', 'bill-54.5.xml', 'birth-28.2.xml',
                                           'body_internal_motion-49.1.xml', 'body_internal_states-40.6.xml',
                                           'body_motion-49.2.xml', 'braid-41.2.2.xml', 'break-45.1.xml',
                                           'break_down-45.8.xml', 'breathe-40.1.2.xml', 'bring-11.3.xml',
                                           'build-26.1.xml', 'bulge-47.5.3.xml', 'bully-59.5.xml', 'bump-18.4.xml',
                                           'butter-9.9.xml', 'calibratable_cos-45.6.1.xml', 'calve-28.1.xml',
                                           'captain-29.8.xml', 'care-88.1.xml', 'caring-75.2.xml', 'carry-11.4.xml',
                                           'carve-21.2.xml', 'caused_calibratable_cos-45.6.2.xml',
                                           'change_bodily_state-40.8.4.xml', 'characterize-29.2.xml', 'chase-51.6.xml',
                                           'cheat-10.6.1.xml', 'chew-39.2.xml', 'chit_chat-37.6.xml',
                                           'classify-29.10.xml', 'clear-10.3.xml', 'cling-22.5.xml', 'cognize-85.xml',
                                           'coil-9.6.xml', 'coloring-24.xml', 'compel-59.1.xml', 'complain-37.8.xml',
                                           'complete-55.2.xml', 'comprehend-87.2.xml', 'comprise-107.2.xml',
                                           'concealment-16.xml', 'conduct-111.1.xml', 'confess-37.10.xml',
                                           'confine-92.xml', 'confront-98.xml', 'conjecture-29.5.xml',
                                           'consider-29.9.xml', 'conspire-71.xml', 'consume-66.xml', 'contain-15.4.xml',
                                           'contiguous_location-47.8.xml', 'continue-55.3.xml', 'contribute-13.2.xml',
                                           'convert-26.6.2.xml', 'cooking-45.3.xml', 'cooperate-73.1.xml',
                                           'cope-83.xml', 'correlate-86.1.xml', 'correspond-36.1.1.xml',
                                           'cost-54.2.xml', 'crane-40.3.2.xml', 'create-26.4.xml', 'curtsey-40.3.3.xml',
                                           'cut-21.1.xml', 'debone-10.8.xml', 'declare-29.4.xml', 'dedicate-79.xml',
                                           'deduce-97.2.xml', 'defend-72.3.xml', 'deprive-10.6.2.xml', 'destroy-44.xml',
                                           'devour-39.4.xml', 'die-42.4.xml', 'differ-23.4.xml', 'dine-39.5.xml',
                                           'disappearance-48.2.xml', 'disassemble-23.3.xml', 'discover-84.xml',
                                           'disfunction-105.2.2.xml', 'distinguish-23.5.xml', 'dress-41.1.1.xml',
                                           'dressing_well-41.3.2.xml', 'drive-11.5.xml', 'dub-29.3.xml',
                                           'earn-54.6.xml', 'eat-39.1.xml', 'empathize-88.2.xml', 'employment-95.3.xml',
                                           'encounter-30.5.xml', 'enforce-63.xml', 'engender-27.1.xml', 'ensure-99.xml',
                                           'entity_specific_cos-45.5.xml', 'entity_specific_modes_being-47.2.xml',
                                           'equip-13.4.2.xml', 'escape-51.1.xml', 'establish-55.5.xml',
                                           'estimate-34.2.xml', 'exceed-90.xml', 'exchange-13.6.1.xml',
                                           'exclude-107.3.xml', 'exhale-40.1.3.xml', 'exist-47.1.xml',
                                           'feeding-39.7.xml', 'ferret-35.6.xml', 'fill-9.8.xml', 'fire-10.10.xml',
                                           'fit-54.3.xml', 'flinch-40.5.xml', 'floss-41.2.1.xml', 'focus-87.1.xml',
                                           'forbid-64.4.xml', 'free-10.6.3.xml', 'free-80.xml', 'fulfilling-13.4.1.xml',
                                           'function-105.2.1.xml', 'funnel-9.3.xml', 'future_having-13.3.xml',
                                           'get-13.5.1.xml', 'give-13.1.xml', 'gobble-39.3.xml', 'gorge-39.6.xml',
                                           'groom-41.1.2.xml', 'grow-26.2.1.xml', 'harmonize-22.6.xml', 'help-72.1.xml',
                                           'herd-47.5.2.xml', 'hiccup-40.1.1.xml', 'hire-13.5.3.xml', 'hit-18.1.xml',
                                           'hold-15.1.xml', 'hunt-35.1.xml', 'hurt-40.8.3.xml', 'illustrate-25.3.xml',
                                           'image_impression-25.1.xml', 'indicate-78.xml',
                                           'initiate_communication-37.4.2.xml', 'inquire-37.1.2.xml',
                                           'instr_communication-37.4.1.xml', 'intend-61.2.xml', 'interact-36.6.xml',
                                           'interrogate-37.1.3.xml', 'invest-13.5.4.xml', 'investigate-35.4.xml',
                                           'involve-107.1.xml', 'judgment-33.1.xml', 'keep-15.2.xml', 'knead-26.5.xml',
                                           'learn-14.xml', 'leave-51.2.xml', 'lecture-37.11.xml', 'let-64.2.xml',
                                           'light_emission-43.1.xml', 'limit-76.xml', 'linger-53.1.xml', 'lodge-46.xml',
                                           'long-32.2.xml', 'lure-59.3.xml', 'manner_speaking-37.3.xml',
                                           'marry-36.2.xml', 'marvel-31.3.xml', 'masquerade-29.6.xml', 'matter-91.xml',
                                           'meander-47.7.xml', 'meet-36.3.xml', 'mine-10.9.xml', 'mix-22.1.xml',
                                           'modes_of_being_with_motion-47.3.xml', 'multiply-108.xml', 'murder-42.1.xml',
                                           'neglect-75.1.xml', 'nonvehicle-51.4.2.xml', 'nonverbal_expression-40.2.xml',
                                           'obtain-13.5.2.xml', 'occur-48.3.xml', 'order-58.3.xml', 'orphan-29.7.xml',
                                           'other_cos-45.4.xml', 'overstate-37.12.xml', 'own-100.1.xml',
                                           'pain-40.8.1.xml', 'patent-101.xml', 'pay-68.xml', 'peer-30.3.xml',
                                           'pelt-17.2.xml', 'performance-26.7.xml', 'pit-10.7.xml', 'pocket-9.10.xml',
                                           'poison-42.2.xml', 'poke-19.xml', 'pour-9.5.xml', 'preparing-26.3.xml',
                                           'price-54.4.xml', 'promise-37.13.xml', 'promote-102.xml',
                                           'pronounce-29.3.1.xml', 'prosecute-33.2.xml', 'push-12.xml', 'put-9.1.xml',
                                           'put_direction-9.4.xml', 'put_spatial-9.2.xml', 'reach-51.8.xml',
                                           'rear-26.2.2.xml', 'reciprocate-112.xml', 'reflexive_appearance-48.1.2.xml',
                                           'refrain-69.xml', 'register-54.1.xml', 'rehearse-26.8.xml',
                                           'reject-77.2.xml', 'relate-86.2.xml', 'rely-70.xml', 'remedy-45.7.xml',
                                           'remove-10.1.xml', 'render-29.90.xml', 'representation-110.1.xml',
                                           'require-103.xml', 'resign-10.11.xml', 'respond-113.xml', 'result-27.2.xml',
                                           'risk-94.xml', 'rob-10.6.4.xml', 'roll-51.3.1.xml', 'rummage-35.5.xml',
                                           'run-51.3.2.xml', 'rush-53.2.xml', 'satisfy-55.7.xml', 'say-37.7.xml',
                                           'scribble-25.2.xml', 'search-35.2.xml', 'see-30.1.xml', 'seem-109.xml',
                                           'send-11.1.xml', 'separate-23.1.xml', 'settle-36.1.2.xml', 'shake-22.3.xml',
                                           'sight-30.2.xml', 'simple_dressing-41.3.1.xml', 'slide-11.2.xml',
                                           'smell_emission-43.3.xml', 'snooze-40.4.xml', 'sound_emission-43.2.xml',
                                           'sound_existence-47.4.xml', 'spank-18.3.xml',
                                           'spatial_configuration-47.6.xml', 'spend_time-104.xml', 'split-23.2.xml',
                                           'spray-9.7.xml', 'stalk-35.3.xml', 'steal-10.5.xml', 'stimulate-59.4.xml',
                                           'stimulus_subject-30.4.xml', 'stop-55.4.xml', 'subjugate-42.3.xml',
                                           'subordinate-95.2.1.xml', 'substance_emission-43.4.xml',
                                           'substitute-13.6.2.xml', 'succeed-74.xml', 'suffocate-40.7.xml',
                                           'supervision-95.2.2.xml', 'support-15.3.xml', 'suspect-81.xml',
                                           'sustain-55.6.xml', 'swarm-47.5.1.xml', 'swat-18.2.xml', 'talk-37.5.xml',
                                           'tape-22.4.xml', 'tell-37.2.xml', 'terminus-47.9.xml', 'throw-17.1.xml',
                                           'tingle-40.8.2.xml', 'touch-20.xml', 'transcribe-25.4.xml',
                                           'transfer_mesg-37.1.1.xml', 'trick-59.2.xml', 'trifle-105.3.xml',
                                           'try-61.1.xml', 'turn-26.6.1.xml', 'urge-58.1.xml', 'use-105.1.xml',
                                           'vehicle-51.4.1.xml', 'vehicle_path-51.4.3.xml', 'vn_class-3.dtd',
                                           'vn_schema-3.xsd', 'void-106.xml', 'volunteer-95.4.xml', 'waltz-51.5.xml',
...
class eventMaker:
    def __init__(self, sentence, common_names, memory):
    ...
    def removePunct(self):
        ...
        original_sent = re.sub("(?<![a-zA-Z]{2,})\.", "", original_sent,
                               flags=re.IGNORECASE)  # removes periods in initials
        while "  " in original_sent:
            original_sent = original_sent.replace("  ", " ")
        self.noPunctSent = original_sent
        return original_sent

    def getSkeletonParse(self, parse):
    ...
    def findVerbFromSyntax(self, classIDs, parse):
        # get the dependency parse, the parsed sentence (NPs, PPs, etc.), and the list of the parts of speech
        parsed_sentence, parsed_pos = self.getSkeletonParse(parse)

        bareIDs = list(set(["-".join([cla.split("-")[0], cla.split("-")[1]]) for cla in classIDs if
                            cla.count("-") > 1]))  # get the superclass instead
        classIDs += bareIDs
                            ...
                            for pos in POSs:  # for each POS in the frame
                                ...
                                if pos.attrib:  # not a VERB or ADV, given a value
                                    ...
                                    for i in range(x, len(parsed_sentence)):
                                        if type(parsed_sentence[i]) == Tree and pos.tag == parsed_sentence[
                                            i].label():  # matching POS
                                            x += 1
                                            break
                                            ...
                                            if type(parsed_sentence[x]) == str:  # parsed is still on verb
                                                wrongPrep = True
                                                break
                                            elif pos.attrib['value'] and pos.attrib['value'][
                                                0].islower():  # if it's an actual list of prepositions
                                                prep = ""
                                                for subtree in parsed_sentence:  # finds the pp for this noun
                                                    ...
                                                    if subtree.label() == "PP":
                                                        ...
                                                        if parsed_sentence[x].leaves()[0] in leaves:
                                                            ...
                                                            self.prep = prep
                                                            break
                                                if prep and prep in pos.attrib[
                                                    'value']:  # if the preposition is in this space-delimited list
                                                    preps += [prep]
                                                    break
                                                else:
                                                    wrongPrep = True
    ...
    def getCurrentSentenceNElist(self):
        ...
        for ner_word in NER:
            if " " + ner_word + " " in new_sent or new_sent.startswith(ner_word + " ") or new_sent.endswith(
                    " " + ner_word):
                ...
                for already_tagged in sentence_NE_list:
                    if len(ner_word) > len(
                            already_tagged) and already_tagged in ner_word and already_tagged not in toRemove:
    ...
    def lookupAdj(self, word, pos, original_sent):
        # This is a function that supports generalize_noun function
        if len(wn.synsets(word)) > 0:
            word1 = lesk(original_sent.split(), word)
            try:
                hyper = lambda s: s.hypernyms()
                TREE = word1.tree(hyper, depth=6)
                temp_tree = TREE
    ...
    def generalize_noun(self, word, tokens, sentence_NE_list):
        # This function is to support getEvent functions. Tokens have specific format(lemma, pos, ner)
        original_sent = self.sentence
        lemma = tokens[word][0]
        pos = tokens[word][1]
        ner = "<" + tokens[word][2].upper() + ">"
        resultString = ""
        new_sent = ""
        curr_sent_NEs = sentence_NE_list.keys()

        if word in self.memory.NEnums.inverse:
            return self.memory.NEnums.inverse[word]
        for sent_NE in curr_sent_NEs:
            if word.lower() == sent_NE or word.lower() in sent_NE.split(
                    " "):  # this noun is a subset of one of the pre-tagged NEs
                ner = sentence_NE_list[sent_NE]
                for collectedNE in self.memory.NEnums.inverse:
                    # for each named entity that we already have under this tag
                    if allXinY(sent_NE, collectedNE):
                        resultString = self.memory.NEnums.inverse[collectedNE]
                        return resultString
                    elif allXinY(collectedNE, sent_NE):  # new name is bigger, replace it
                        index = self.memory.NEnums.inverse[collectedNE]
                        self.memory.NEnums[index] = sent_NE
                        return self.memory.NEnums.inverse[sent_NE]
                # we got a new named entity!
                newNum = self.memory.findFreeNameNumber(ner)
                self.memory.NEnums[ner + str(newNum)] = sent_NE
                return ner + str(newNum)
        if word in NER:
            ner = NER[word]
            newNum = self.memory.findFreeNameNumber(ner)
            self.memory.NEnums.inverse[ner + str(newNum)] = word
            return ner + str(newNum)
        ...
        if lemma == "anyone" or lemma == "anybody":
            return "<PRP>"
        if lemma == "anything":
            return "<PRP>"
        if "NN" in pos:
    ...
    def getEvent(self):
        ...
        json_data = self.callStanford(sentence)
        json_load = json.loads(json_data)
        all_json = json_load["sentences"]

        for sent_num, sentence in enumerate(all_json):
            # setup parameters
            ...
            for d in deps:
                ...
                if 'nsubj' in d["dep"] and "RB" not in tokens[d["dependentGloss"]][1]:
                        ...
                        # Object is a verb
                            ...
                            for i, obj in reversed(list(enumerate(objects))):
                                if obj == d["governorGloss"] and modifiers[i] == "EmptyParameter":
                                    ...
                                    index[d["dependentGloss"]] = d["dependent"]
                    # case 2: nmod
                    elif ('nmod' in d["dep"] or 'ccomp' in d["dep"] or 'iobj' in d["dep"] or 'dep' in d[
                        "dep"]) and 'NN' in tokens[d["dependentGloss"]][1]:
                        if d["governorGloss"] in verbs:
                    ...
                    # PRP (pronoun)
                        ...
                        "dep"]) and 'PRP' in tokens[d["dependentGloss"]][1]:
                        if d["governorGloss"] in verbs:
                            # modify that modifier
                            for i, verb in reversed(list(enumerate(verbs))):
                                if verb == d["governorGloss"] and modifiers[i] == "EmptyParameter":
            ...
            for (a, b, c, d) in zip(subjects, verbs, objects, modifiers):
                num = 0
                if a != 'EmptyParameter':
                    a1 = self.generalize_noun(a, tokens, sentence_NE_list)
                    if ">" in a1 and a1 != "<PRP>":
                        tag = a1.split(">")[0] + ">"
                        ...
                        tag = a1
                    if a1 == a:
                        a1 = self.generalize_verb(a, tokens, sentence["parse"].replace("\n", ""))
                    ...
                    a1 = a
                if b != 'EmptyParameter':
                    b1 = self.generalize_verb(b, tokens, sentence["parse"].replace("\n", ""))
                    self.verbs[b1].append(tokens[b][0])
                else:
                    b1 = b
                if c != 'EmptyParameter':
                    c1 = self.generalize_noun(c, tokens, sentence_NE_list)
                    if ">" in c1 and c1 != "<PRP>":
                        tag = c1.split(">")[0] + ">"
                    else:
                        tag = c1
                    if c1 == c:
                        c1 = self.generalize_verb(c, tokens, sentence["parse"].replace("\n", ""))
                ...
                if d != 'EmptyParameter':
                    d1 = self.generalize_noun(d, tokens, sentence_NE_list)
                    if ">" in d1 and d1 != "<PRP>":
                        tag = d1.split(">")[0] + ">"
                    else:
                        tag = d1
                ...
                if returningEvent:
                    return returningEvent_orig, returningEvent, event_nouns
                else:
                    return [], [], None
