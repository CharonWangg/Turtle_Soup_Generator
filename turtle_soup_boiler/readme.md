...
## Usage
  ...
  tsb.generate_by_input(verbose=False)                      # Generate story by keyboard input a initial start
  tsb.generate_by_text(verbose=False)                       # Generate story by input a string 
